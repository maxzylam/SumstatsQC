...
##### Define help script #######################################
    ...
    function helpscript {
        ...
        echo "  --localout=destfolder               ### What is the destination folder for storage"
        echo "  --archive={G | L}                   ### Transfer SumstatsQC results folder to local destination to google cloud bucket or local storage"
        echo "  --bucket=gs://address/              ### if G is invoked for --archive state bucket address, assumes user has Gcloud SDK installed"
        echo ""
        echo ""
        echo "exiting ..."
        echo ""
